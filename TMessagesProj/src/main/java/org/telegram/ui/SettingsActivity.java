...
//        fragmentView.addView(navigationBar, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 0, Gravity.BOTTOM | Gravity.FILL_HORIZONTAL));
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(SettingCell.Factory.of(org.telegram.ui.mzgram.MZGramSettingsActivity.SETTINGS_ROW_ID, IconBackgroundColors.CYAN.top, IconBackgroundColors.CYAN.bottom, R.drawable.settings_features, getString(R.string.MZGram), getString(R.string.MZGramSettingsInfo)));
    ...
    private void onClick(UItem item, View view, int position, float x, float y) {
        ...
        switch (item.id) {
            ...
            case 10:
                ...
                break;
            case org.telegram.ui.mzgram.MZGramSettingsActivity.SETTINGS_ROW_ID:
                presentSettingFragment(new org.telegram.ui.mzgram.MZGramSettingsActivity());
                break;
